...
@section('search.target',route('shop.goods'))
@section('content')
...
<script>
    const products = [
      {
        id: "1",
        category: ["ชา"],
        image: "{{ asset('shop/img/ชาไทย.jpg') }}",
        name: "ชาไทย",
        price: "60 บาท",
        description:
      ...
      },
      {
        id: "2",
        category: ["ลาเต้"],
        image: "{{ asset('shop/img/กุหลาบลาเต้.jpg') }}",
        name: "กุหลาบลาเต้",
        price: "60 บาท",
        description:
      ...
      },
      {
        id: "3",
        category: ["ลาเต้"],
        image: "{{ asset('shop/img/โกโก้ลาเต้.jpg') }}",
        name: "โกโก้ลาเต้",
        price: "60 บาท",
        description:
      ...
      },
      {
        id: "4",
        category: ["ชา"],
        image: "{{ asset('shop/img/ชาเขียวมัทฉะชิอาวาเสะ.jpg') }}",
      ...
      },
      {
        id: "5",
        category: ["มีความสุข"],
        image: "{{ asset('shop/img/ชานมมีความสุข.jpg') }}",
        name: "ชานมมีความสุข",
        price: "60 บาท",
        description:
    ...
    id: "6",
    category: ["ผลไม้"],
    image: "{{ asset('shop/img/ชาผลไม้รวม.jpg') }}",
    name: "ชาผลไม้รวม",
    price: "60 บาท",
    description:
  ...
  },
  {
    id: "7",
    category: ["ผลไม้"],
    image: "{{ asset('shop/img/ชาลูกพีช.jpg') }}",
    name: "ชาลูกพีช",
    price: "60 บาท",
    description:
  ...
  },
  {
    id: "8",
    category: ["ผลไม้"],
    image: "{{ asset('shop/img/ชาสตรอเบอร์รี่.jpg') }}",
    name: "ชาสตรอเบอร์รี่",
    price: "60 บาท",
    description:
  ...
  },
  {
    id: "9",
    category: ["ผลไม้"],
    image: "{{ asset('shop/img/ชาอัญชันน้ำผึ้งมะนาว.jpg') }}",
  ...
  },
  {
    id: "10",
    category: ["มีความสุข"],
    image: "{{ asset('shop/img/นมสดโคฟูกุ.jpg') }}",
    name: "นมสดโคฟูกุ",
    price: "60 บาท",
    description:
  ...
  },
  {
    id: "11",
    category: ["ลาเต้"],
    image: "{{ asset('shop/img/อัญชันลาเต้.jpg') }}",
    name: "อัญชันลาเต้",
    price: "60 บาท",
    description:
    ...
    products.forEach((product) => {
      const productHTML = `
        <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
          <a href="{{ route('shop.detail') }}" onclick="saveProductDetails('${product.id}')">
